  ...
  const testimonials = [
    {
      ...
      image: "https://placehold.co/100/F8EE00/000000?text=MJ",
    ...
    },
    {
      ...
      image: "https://placehold.co/100/F8EE00/000000?text=SW",
    ...
    },
    {
      ...
      image: "https://placehold.co/100/F8EE00/000000?text=DR",
    ...
    },
    {
      ...
      image: "https://placehold.co/100/F8EE00/000000?text=EC",
    ...
    <section className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <span className="inline-block py-1 px-3 rounded-none bg-[#F8EE00]/30 text-black text-sm font-medium mb-4">
            Testimonials
          </span>
