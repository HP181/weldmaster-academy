        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 max-w-lg">
            ...
            <div className="flex flex-wrap gap-4">
              <Button className="bg-[#ffc107] text-black font-bold px-6 py-3 rounded-md shadow-lg transition-all transform hover:-translate-y-1 hover:shadow-2xl hover:bg-[#ffb300]">
                Explore Courses
              </Button>
